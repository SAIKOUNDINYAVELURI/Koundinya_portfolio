export const heroData = {
 ...
 role: [
  ...
  social: {
    ...
    linkedin: "https://www.linkedin.com/in/sai-koundinya-veluri-5800aa257/",
...
export const skillsData = [
...

  {
    ...
    skills: [
      ...
      { name: "JWT",   logo: "https://logo.svgcdn.com/logos/jwt-icon.svg"  }
  ...
  {
    category: "MachineLearning & DataScience",
    skills: [
...
export const aboutData = {
  ...
  education: [
    ...
    },
    {
      ...
      college: "Arka Institutions",
      year: "2020 – 2022"
    },
    {
      degree: "SSC",
      college: "Kenedy E.M. High School",
      year: "2019-2020"
    }
  ],

  certifications: [
    { name: "Salesforce Developer Virtual Internship", org: "SmartBridge & AICTE", year: "Nov 2024 - Jan 2025" },
    { name: "Cloud Computing", org: "NPTEL(Elite)", year: "2025" },
    { name: "Cisco Python Essentials", org: "Cisco NetAcad",year:"2024" }
  ],
  achievements: [
    {
      title: "Hackathon Winner",
      description: "Won a competitive hackathon for outstanding performance and innovation.",
      organizer: "Samanyastra"
    }
  ]
};
export const contactData = {
  email: "saikoundinya2005@gamil.com",
  linkedin: "https://www.linkedin.com/in/sai-koundinya-veluri-5800aa257/",
  github: "https://github.com/SAIKOUNDINYAVELURI"
};
